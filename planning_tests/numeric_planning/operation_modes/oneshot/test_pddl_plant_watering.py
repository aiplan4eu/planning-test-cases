...
class TestPddlPlantWatering(TestCase):
    ...
    def setUp(self):
        ...
        self.problem_18_2 = plant_watering_18_2(expected_version=1)
        self.problem_20_3 = plant_watering_20_3(expected_version=1)
    ...
    def test_problem_18_2(self):
        self.execute_one_shot_planning_test(self.problem_18_2.get_problem())

    def test_problem_20_3(self):
        self.execute_one_shot_planning_test(self.problem_20_3.get_problem())
