...
from planning_tests.numeric_planning.pddl_problems.TPP.pddl_TPP import TPP_p01, TPP_p02
import pytest
import sys
...
class TestPddlTPP:
	...
	planner_names = get_planner_names(TPP_p02.get_problem().kind)
	...
	#@pytest.mark.parametrize("problem_name,problem",[("TPP_p01",TPP_p02 )])
