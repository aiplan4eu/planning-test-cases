...
from planning_tests.numeric_planning.pddl_problems.block_grouping.block_grouping import block_grouping_5_5_2_1, block_grouping_5_5_2_2, block_grouping_5_5_2_3, block_grouping_20_25_6_3, block_grouping_20_25_6_2
        ...
        for p in planner_names:
            with OneshotPlanner(name=p) as planner:
                if planner.supports(problem.kind):
                    ...
                    #aggiungere _{p} dopo il nome del file per stampare il pianificatore corrispondente
